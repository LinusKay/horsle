<script context="module" lang="ts">
	const tips = [
		"You can change the gamemode by clicking HORSLE or swiping the board left or right.",
		...
		"Everyone has the same horsle at the same time. Your word #73 is the same as everyone elses #73.",
